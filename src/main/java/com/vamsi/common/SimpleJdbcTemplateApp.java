...
import com.vamsi.customer.dao.CustomerDAO;
import com.vamsi.customer.model.Customer;
...
public class SimpleJdbcTemplateApp 
{
    public static void main( String[] args )
    {
        ...
        Customer customer1 = new Customer(1, "vamsi1",21);
        Customer customer3 = new Customer(2, "vamsi2",22);
        Customer customer2 = new Customer(3, "vamsi3",23);
        ...
        Customer customer4 = new Customer(4, "vamsi4",24);
        Customer customer5 = new Customer(5, "vamsi5",25);
        Customer customer6 = new Customer(6, "vamsi6",26);
